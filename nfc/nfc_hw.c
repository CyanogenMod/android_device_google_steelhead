...
static uint8_t pn544_eedata_settings[][4] = {
    ...
    // Settings for 26.0MHz clock
    ,{0x00, 0x98, 0x09, 0x03}  // 26.0MHz input clock for FrcNPLL
    ,{0x00, 0x98, 0x10, 0x3c}  // Use internal FracNPLL for clock generation
    ,{0x00, 0x9E, 0x6F, 0x0A}  // PlClockTimeout == 10mSec
    ,{0x00, 0x9E, 0x71, 0x00}  // PlClockRequest == no request
    ,{0x00, 0x9E, 0x72, 0x00}  // PlClockTimeout == ack'ed thanks to timeout
};
